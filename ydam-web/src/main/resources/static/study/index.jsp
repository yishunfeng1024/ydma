...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/study/bootstrap/css/bootstrap.css">
		<link rel="stylesheet" type="text/css" href="/study/css/muke.css">
		
		<!-- 网页标题栏图标 -->
		<link rel="SHORTCUT ICON" href="/study/img/favicon.ico"/>
				...
				<div class="width100 float_l height460 posi_relative">
					<div class="width100 float_l">
						<div class="focusBox">
							<ul class="pic">
								<li>
									<a href="/study/course_list.jsp"><img src="/study/img/index1.jpg" /></a>
								</li>
								<li>
									<a href="/study/course_list.jsp"><img src="/study/img/index2.jpg" /></a>
								</li>
								<li>
									<a href="/study/course_list.jsp"><img src="/study/img/index3.jpg" /></a>
								</li>
								<li>
									<a href="/study/course_list.jsp"><img src="/study/img/index4.jpg" /></a>
								</li>
								<li>
									<a href="/study/course_list.jsp"><img src="/study/img/index5.jpg" /></a>
								</li>
							</ul>
								...
								<div class="width100 float_l padding40">
									<div class="width100 float_l margin_b40">
										...
										<ul class="width100 ul_lis float_l">
											<li>
												<a href="/study/course_list.jsp">HTML/CSS</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">JavaScript</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">jQuery</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Html5</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">CSS3</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Node.js</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">AngularJS</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Bootstrap</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">React</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Sass/Less</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Vue.js</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">WebApp</a>
											</li>
											<li>/</li>
										</ul>
									</div>
							...
							<div class="width_700 float_l lunbofenlei dis_none img_backg16">
								<div class="width100 float_l padding40">
									<div class="width100 float_l margin_b40">
										...
										<ul class="width100 ul_lis float_l">
											<li>
												<a href="/study/course_list.jsp">PHP</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Java</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Python</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">C</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">C++</a>
											...
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Go</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">C#</a>
											...
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Ruby</a>
											</li>
										</ul>
									</div>
							...
							<div class="width_700 float_l lunbofenlei dis_none img_backg17">
								<div class="width100 float_l padding40">
									<div class="width100 float_l margin_b40">
										...
										<ul class="width100 ul_lis float_l">
											<li>
												<a href="/study/course_list.jsp">Android</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">iOS</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Unity3D</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Cocos2d-x</a>
											</li>
										</ul>
									</div>
							...
							<div class="width_700 float_l lunbofenlei dis_none img_backg18">
								<div class="width100 float_l padding40">
									<div class="width100 float_l margin_b40">
										...
										<ul class="width100 ul_lis float_l">
											<li>
												<a href="/study/course_list.jsp">MySQL</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">MongoDB</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Oracle</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">SQLServer</a>
											</li>
										</ul>
									</div>
							...
							<div class="width_700 float_l lunbofenlei dis_none img_backg16">
								<div class="width100 float_l padding40">
									<div class="width100 float_l margin_b40">
										...
										<ul class="width100 ul_lis float_l">
											<li>
												<a href="/study/course_list.jsp">大数据</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">云计算</a>
											</li>
										</ul>
									</div>
							...
							<div class="width_700 float_l lunbofenlei dis_none img_backg15">
								<div class="width100 float_l padding40">
									<div class="width100 float_l margin_b40">
										...
										<ul class="width100 ul_lis float_l">
											<li>
												<a href="/study/course_list.jsp">测试</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">Linux</a>
											</li>
										</ul>
									</div>
							...
							<div class="width_700 float_l lunbofenlei dis_none img_backg17">
								<div class="width100 float_l padding40">
									<div class="width100 float_l margin_b40">
										...
										<ul class="width100 ul_lis float_l">
											<li>
												<a href="/study/course_list.jsp">动画特效</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">APPUI设计</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">设计工具</a>
											</li>
											<li>/</li>
											<li>
												<a href="/study/course_list.jsp">设计基础</a>
											</li>
										</ul>
									</div>
			...
			<div class="width_1200 margin_auto">
				<div class=" width_220 height364 float_l img_backg3 margin_r20">
					...
					<div class="width100 float_l padding_lr20 color_white fon_siz16 margin_t30 jiantoubianhua bianshou">
						<a href="/study/download/HTML5.CHM"><span>API 下载<span class="margin_l5 wobianhua">></span></span></a>
					</div>
		...
		<div class="width100 float_l backg_qiangray padding_b45">
			<div class="width_1200 margin_auto">
				<div class=" width_220 height364 float_l img_backg11 margin_r20">
					...
					<div class="width100 float_l padding_lr20 color_white fon_siz16 margin_t30 jiantoubianhua bianshou">
						<a href="/study/download/JDK_API_1_6_zh_CN.CHM"><span>API 下载<span class="margin_l5 wobianhua">></span></span></a>
					</div>
				...
				<div class="width_1200 margin_auto">
					<div class="width100 float_l" id="courseOracle">
						<div class=" width_220 height172 float_l img_backg14 margin_r20">
							...
							<div class="width100 float_l padding_lr20 color_white fon_siz16 margin_t30 jiantoubianhua bianshou">
								<a href="/study/download/ORACLE.chm"><span>API 下载<span class="margin_l5 wobianhua">></span></span></a>
							</div>
						</div>
						 <div class="width_220 height172 float_l margin_r20 border_shadow jingguoxianshi over_pos bianshou">
							<div class="width100 float_l img_100 z_inx_1">

    ...
    <div id="setting-profile" class="setting-wrap setting-profile">
      ...
      <div class="info-wapper">
             <div class="info-box clearfix">
                <label class="pull-left">用户名</label><div class="pull-left"><input id="yyy_name" type="text" placeholder="这里输入昵称" name="nick_name" /></div>
            </div>
            <div class="info-box clearfix">
                <label class="pull-left">密码</label><div class="pull-left"><input id="yyy_oldpass" type="password"  name="password"/><img id="yyy_img" src=""/></div>
            </div>
            <div class="info-box clearfix"><label class="pull-left">新密码</label><div class="pull-left"><input id="yyy_newpass" type="text"  name="newpassword"/></div>
            </div>
            <div class="info-box clearfix"><label class="pull-left">确认</label><div class="pull-left"><input id="yyy_submitpass"  type="text" /><span id="sgy_result"></span></div>
            </div>
            <div id="yyy_submit" class="info-box clearfix"><label id="submit_sgy" class="pull-left">提交</label>
            </div>
        </div> 
    </div>
</div>    
